<?php
	...
	{
		$sql_query = "
		SELECT PRODUCT_GROUP_ID, NAME, PRODUCT_DESCR, CASES_PER_PALLET, UNITS_PER_CASE, COST_PRICE, GUIDE_DISCOUNT, SELLING_PRICE, PRODUCT_TYPE.TYPE_NAME, PRODUCT_MEASUREMENT, PRODUCT_MEASUREMENT_UNIT,
