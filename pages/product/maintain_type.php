                  ...
                  <div class="tab-pane fade show active" id="home"  aria-labelledby="home-tab">
                    <form>
                      <div class="form-group col">
                        <label for="bane">Product Type Name</label>
                        <input type="email" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Beverage">
                      </div>

                      <div class="form-group col">
                        <label for="des">Type Description</label>
                         <textarea class="form-control" id="des" rows="2" placeholder="Any coldrinks, juice or concerntrates."></textarea>
                      </div>


                      <div class="col">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default">Save</button>
                        <button class="btn btn-icon btn-2 btn-danger mt-0 px-4 float-right" type="button" data-toggle="modal" data-target="#modal-del">
                          ...
                          <span class="btn-inner--text" >Delete Product Type</span>
                        </button>
                    </form>
                    ...
                    <div class="modal fade" id="success2" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
                      <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <p>The product type was successfully deleted</p>
                              </div>
                              <div class="modal-footer">
