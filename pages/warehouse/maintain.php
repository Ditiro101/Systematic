...
<head>
  ...
  <title>Maintain Warehouse - Stock Path</title>
  <!-- Favicon -->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Maintain Warehouse</a>
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">Maintain Warehouse details:</h3>
            </div>
            <div class="card-body">
