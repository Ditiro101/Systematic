...
<head>
  ...
  <title>Maintain Assigned Collections - Stock Path</title>
  <!-- Favicon -->
...
<body>
 <?php include_once("../header.php");?>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Maintain Assigned Collections</a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>Are you sure you want to remove the assignment products from the selected truck?</p>
                    </div>
  ...
  <script type="text/javascript" src="JS/maintainAssignedCollection.js"></script>
</body>
