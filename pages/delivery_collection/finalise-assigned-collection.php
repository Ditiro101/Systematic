...
<head>
  ...
  <title>Finalise Assigned Collections - Stock Path</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Finalise Assigned Collection</a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>Are you sure you want to finalise the assignment products of the selected collection(s) to the selected truck?</p>
                    </div>
  ...
  <script type="text/javascript" src="JS/finaliseAssignedCollection.js"></script>
</body>
