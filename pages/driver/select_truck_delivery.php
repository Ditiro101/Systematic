...
<head>
  ...
  <title>Select Truck Delivery - Stock Path</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Sale Delivery</a>
      ...
      <div class="row mb-3">
          <div class="card shadow col">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">Make Delivery</h3>
            </div>
            <div class="card-body">    
                  <br>          
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>Are you sure you want to select this truck to make a Sale delivery?</p>
                    </div>
                    <div class="modal-footer">
                      
                    <form action="list_delivery.php" method="POST">
  ...
  <script type="text/javascript" src="JS/selectDeliveryTruck.js"></script>
</body>
