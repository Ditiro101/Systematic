                ...
                <div class="col">
                  <div class="card shadow border-0 gmap_canvas">
                    <?php $address = $_POST["address"] ; /* Insert address Here */
                      ...
                      echo '<iframe width="130%" height="400" frameborder="0" src="https://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q=' . str_replace(",", "", str_replace(" ", "+", $address)) . '&z=14&output=embed"></iframe>';
                    ?>
                  </div>
                  <style>
